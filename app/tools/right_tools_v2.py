...
from app.clients.estate_ai_client_v2 import EstateAiClientV2


class RightToolsV2:
    def __init__(self, client: EstateAiClientV2 | None = None) -> None:
        self._client = client or EstateAiClientV2()
